...
#define SWIG_init    boot_XFSM

#define SWIG_name   "XFSMc::boot_XFSM"
#define SWIG_prefix "XFSMc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_XFSM_var::
class _wrap_XFSM_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
